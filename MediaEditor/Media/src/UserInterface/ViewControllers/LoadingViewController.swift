...
public class LoadingViewController: UIViewController {
    ...
    override public func loadView() {
        ...
        self.logoView = UIImageView(image: #imageLiteral(resourceName: "media-composer-close"))
        ...
        let v = UIButton(frame: CGRect(x: 0, y: 0, width: 300, height: 300))
        v.backgroundColor = UIColor.red
        v.addTarget(self, action: #selector(openPNav), for: .touchUpInside)
