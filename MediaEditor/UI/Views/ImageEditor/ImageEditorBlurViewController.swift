...
public class ImageEditorBlurViewController: OWSViewController {
    ...
    public override func loadView() {
        ...
        autoBlurLabel.text = "IMAGE_EDITOR_BLUR_SETTING"
        autoBlurLabel.font = UIFont.systemFont(ofSize: 15)
        ...
        drawAnywhereHint.font = UIFont.systemFont(ofSize: 15)
        ...
        drawAnywhereHint.text = "IMAGE_EDITOR_BLUR_HINT"
    ...
    @objc func didToggleAutoBlur(sender: UISwitch) {
        ...
        ModalActivityIndicatorViewController.present(
            ...
            func showToast() {
                let toastController = ToastController(text:
