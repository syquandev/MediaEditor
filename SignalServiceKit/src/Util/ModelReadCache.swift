...
class ModelCacheValueBox<ValueType: BaseModelX> {
    let value: ValueType?
...
class ModelCacheAdapter<KeyType: Hashable & Equatable, ValueType: BaseModelX> {
...
class ModelReadCache<KeyType: Hashable & Equatable, ValueType: BaseModelX>: Dependencies, CacheSizeLeasing {
...
class TestableModelReadCache<KeyType: Hashable & Equatable, ValueType: BaseModelX>: ModelReadCache<KeyType, ValueType> {
...
public class ModelReadCacheFactory: NSObject {
    func create<KeyType: Hashable & Equatable, ValueType: BaseModelX>(mode: ModelReadCache<KeyType, ValueType>.Mode,
...
class TestableModelReadCacheFactory: ModelReadCacheFactory {
    override func create<KeyType: Hashable & Equatable, ValueType: BaseModelX>(mode: ModelReadCache<KeyType, ValueType>.Mode,
                                                                              adapter: ModelCacheAdapter<KeyType, ValueType>) -> ModelReadCache<KeyType, ValueType> {
